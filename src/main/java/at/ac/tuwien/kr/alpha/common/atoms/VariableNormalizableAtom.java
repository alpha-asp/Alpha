...
/**
 * Interface for atom whose variables can be normalized, i.e., enumerated from left to right.
...
public interface VariableNormalizableAtom {
	 ...
	 * @return the Atom where all variables are renamed and enumerated left-to-right.
	 */
