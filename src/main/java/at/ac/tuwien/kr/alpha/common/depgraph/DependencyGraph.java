...
/**
 * The dependency graph of an ASP program. Nodes in the graph are predicates occurring in rule heads, edges are rule body literals. An edge may be positive or
 * negative, reflecting either a positive or default negated atom.
 * 
