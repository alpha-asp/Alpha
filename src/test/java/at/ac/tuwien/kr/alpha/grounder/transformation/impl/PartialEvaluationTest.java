...
public class PartialEvaluationTest {
	...
	public static Iterable<Object[]> params() {
		...
		testCases.add(new ImmutablePair<>(BASIC_TEST_ASP, PartialEvaluationTest::verifyBasic));
		testCases.add(new ImmutablePair<>(BASIC_MULTI_INSTANCE_ASP, PartialEvaluationTest::verifyBasicMultiInstance));
	...
	public PartialEvaluationTest(String aspString, Consumer<InternalProgram> verifier) {
