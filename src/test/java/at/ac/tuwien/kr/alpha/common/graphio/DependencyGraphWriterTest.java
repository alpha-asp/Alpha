...
public class DependencyGraphWriterTest {
	...
	public void smokeTest() {
		...
		String asp = "p(X) :- q(X), r(X).\n" +
				...
				"u(X) :- p(X), not t(X).\n" +
				":- p(X), not q(X), not r(X).";
		String expectedGraph = "digraph dependencyGraph\n" +
				"{\n" +
				"splines=false;\n" +
				"ranksep=4.0;\n" +
				"n0 [label = \"r/1\"]\n" +
				...
				"n5 [label = \"[constr_1]/0\"]\n" +
				"n6 [label = \"p/1\"]\n" +
				"n0 -> n6 [xlabel=\"+\" labeldistance=0.1]\n" +
				"n0 -> n3 [xlabel=\"-\" labeldistance=0.1]\n" +
				"n0 -> n5 [xlabel=\"-\" labeldistance=0.1]\n" +
				"n1 -> n6 [xlabel=\"+\" labeldistance=0.1]\n" +
				"n1 -> n3 [xlabel=\"+\" labeldistance=0.1]\n" +
				"n1 -> n5 [xlabel=\"-\" labeldistance=0.1]\n" +
				"n2 -> n4 [xlabel=\"-\" labeldistance=0.1]\n" +
				"n4 -> n2 [xlabel=\"-\" labeldistance=0.1]\n" +
				"n5 -> n5 [xlabel=\"-\" labeldistance=0.1]\n" +
				"n6 -> n3 [xlabel=\"+\" labeldistance=0.1]\n" +
				"n6 -> n2 [xlabel=\"+\" labeldistance=0.1]\n" +
				"n6 -> n4 [xlabel=\"+\" labeldistance=0.1]\n" +
				"n6 -> n5 [xlabel=\"+\" labeldistance=0.1]\n" +
				"}\n";
