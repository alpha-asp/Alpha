...
public class AnalyzedProgram extends InternalProgram {
	...
	public AnalyzedProgram(List<InternalRule> rules, List<CoreAtom> facts) {
		super(rules, facts);
	...
	public static AnalyzedProgram analyzeNormalProgram(NormalProgram prog) {
		ImmutablePair<List<InternalRule>, List<CoreAtom>> rulesAndFacts = InternalProgram.internalizeRulesAndFacts(prog);
