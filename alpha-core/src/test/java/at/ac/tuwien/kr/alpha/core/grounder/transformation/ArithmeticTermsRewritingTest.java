...
public class ArithmeticTermsRewritingTest {
	...
	private final ProgramParser parser = new ASPCore2ProgramParserImpl(externalsOfThisClass);	// Create parser that knows an implementation of external atom &extArithTest[]().
